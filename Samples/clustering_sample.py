...
fiveth_cluster = train_feat.loc[model.labels_ == 4,:]
# sixth_cluster = train_feat.loc[model.labels_ == 5,:]

# Plotting the results
plt.scatter(first_cluster.loc[:, 'Spending'], first_cluster.loc[:, 'Income'], color='red')
plt.scatter(second_cluster.loc[:, 'Spending'], second_cluster.loc[:, 'Income'], color='black')
plt.scatter(third_cluster.loc[:, 'Spending'], third_cluster.loc[:, 'Income'], color='blue')
plt.scatter(fourth_cluster.loc[:, 'Spending'], fourth_cluster.loc[:, 'Income'], color='green')
plt.scatter(fiveth_cluster.loc[:, 'Spending'], fiveth_cluster.loc[:, 'Income'], color='orange')
plt.scatter(sixth_cluster.loc[:, 'Spending'], sixth_cluster.loc[:, 'Income'], color='pink')
plt.show()
